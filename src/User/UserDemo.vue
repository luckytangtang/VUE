      ...
      <el-tabs v-model="activeName">
        <el-tab-pane label="Information" name="index">
          ...
          <div class="panel-heading">
            ...
            <span class="title"><p class="role">{{username}}</p><span class="name">Administrator</span> </span>
            ...
            <ul>
              ...
              <li>
                <el-row :gutter="20">
                  ...
                  <el-col :span="12">Birthday</el-col>
              ...
              <li>
                <el-row :gutter="20">
                  ...
                  <el-col :span="12">Cellphone</el-col>
                  <el-col :span="6">{{phone}}</el-col>
                </el-row>
              </li>
              <li>
                <el-row :gutter="20">
                  <el-col :span="6"><i class="fa fa-calendar"></i></el-col>
                  <el-col :span="12">Create Time</el-col>
        ...
        <el-tab-pane label="Modify the picture" name="second"></el-tab-pane>
        <el-tab-pane label="Change password" name="third"></el-tab-pane>
      </el-tabs>
    </el-card>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    components: {Header},
    data() {
      var loginuser=window.JSON.parse(window.sessionStorage.getItem("loginuser"))
      return {
        id:loginuser.id,
        username:loginuser.username,
        email:loginuser.email,
        gender:loginuser.gender==0?'boy':'girl',
        phone:loginuser.phone,
        create_time:loginuser.create_time,
