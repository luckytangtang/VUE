<template>
  <div>
      ...
      <el-row>
        ...
        <el-col :span="10" class="grid-content ">
          <el-card class="box-card">
            ...
            <div >
              <el-form-item>
                <el-input type="text" placeholder="请输入论文名称" v-model="formItem.title">
                </el-input>
              </el-form-item>
            </div>
            ...
            <div>
              <el-form-item>
                <el-input type="text" placeholder="请输入第一作者名" v-model="formItem.author"><div style="margin: 20px 0;"></div>
                </el-input>
              </el-form-item>
            </div>
            <div style="margin: 20px 0;"></div>
            <div >
              <el-form-item>
                <el-button style="margin: 20px 0 0 0; " type="primary" @click="submitForm">确定上传
                </el-button>
              </el-form-item>
            </div>
          </el-card>
    ...
    <div class="option">
      <el-button @click="hreftwo" round style="margin-left: 20px" type="info">在线阅览</el-button>
      <el-button round style="margin-left: 20px" type="info">立即下载</el-button>
      <el-link style="float:right;margin-right: 20px;" type="primary">查看我的历史论文</el-link>
      <el-link style="float:right;margin-right: 20px;" type="primary">再次上传</el-link>
    </div>
    <div class="line" style="height: 20px"></div>
    <div class="description">
      <el-card class="box-card" style="width:100%">
        ...
        <div :key="o" class="text item" v-for="o in 4">
          {{'说明 '+ o + ': 右侧耳罩上，设有滑动触控功能（仅在蓝牙模式开启状态下可用）音乐切换、音量调节可实现简易式轻触操作'}}
        </div>
      </el-card>
    </div>
  </div>
